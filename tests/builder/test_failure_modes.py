...
#:
#: `MCP_CONNECTION_ERROR_CLASS` and `tests/service/mcp_fixture_server.py` are
#: plan 07's and import unconditionally: while plans 07 and 12 were built on
#: separate branches they sat inside this guard, and the Integrator removed
#: that on the merge (2026-09-04) so the MCP arm RUNS rather than skips - three
#: skips read as green and are not.
