# Langfuse figures - run `036ace4e-8b58-4a9b-9d46-0b78448684f9`
...
| --- | --- |
| polls | 6 |
| rate-limited polls (429) | 3 |
| other poll errors | 0 |
| first observation visible after (s, from poll start) | 1.611 |
| count stable after (s, from poll start) | 59.969 |
...
| observation count at that point | 33 |
